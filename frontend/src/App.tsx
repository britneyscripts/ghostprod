...
export default function App() {
  ...
  const handleAnalyze = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setResult({
        url: data.url,
        score: data.ars || 0, // O score geral do orquestrador
        breakdown: {
        ...
        analysis: {
          // No Python: o Agente 4 devolve 'analise' ou 'motivo'
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="glass-card p-8 md:w-1/3 w-full flex flex-col items-center text-center relative overflow-hidden bg-void/50 border border-white/10">
              ...
              <div className="w-full space-y-4">
                ...
                <ScoreBar label="PAGESPEED (LAB DATA)" value={result.breakdown.pagespeed} color="cyan" />
            ...
            <div className="flex-1 space-y-6">
              <div className="glass-card p-6 bg-void/50 border border-white/10">
                <h3 className="font-display text-lg text-neon-cyan mb-4 flex items-center gap-2 uppercase">
